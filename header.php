            ...
            <?php if(osetin_top_bar_member_buttons_visible()){ ?>
              <?php if(is_user_logged_in()){ ?>
                ...
                if(isset($userpro)){
                  ...
                  <?php } ?>
<li><a href="<?php echo esc_attr( get_page_url_by_slug( 'my-comments' ) ) ?>">My Comments</a></li>
                  <?php 
                    ...
                    if($user_meal_plans_permalink){
                      echo '<li><a href="'.$user_meal_plans_permalink.'"><i class="os-icon os-icon-ui-33"></i> <span>'.__('My Meal Plans', 'osetin').'</span></a></li>';
                    }
                   ?>
