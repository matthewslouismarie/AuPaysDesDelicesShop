...
define( 'USP_CORE_CONSTANTS_AND_FUNCTIONS_PATH', get_stylesheet_directory() . '/user-submitted-recipes/definitions/core-constants-and-functions.php' );
define( 'USP_FORM_DISPLAYING_FUNCTIONS_PATH', get_stylesheet_directory() . '/user-submitted-recipes/definitions/form-displaying-functions.php' );
define( 'USP_FORM_PROCESSING_FUNCTIONS_PATH', get_stylesheet_directory() . '/user-submitted-recipes/definitions/form-processing-functions.php' );
define( 'USP_PROCESS_FORM_IF_ANY_PATH', get_stylesheet_directory() . '/user-submitted-recipes/scripts/process-form-if-any.php' );
define( 'USP_INIT_PATH', get_stylesheet_directory() . '/user-submitted-recipes/scripts/init.php' );
