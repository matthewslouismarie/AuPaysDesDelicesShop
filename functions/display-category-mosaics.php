...
require_once( $functions . 'display_subheader.php' );
require_once( $functions . 'display_page_featured_image.php' );
require_once( $functions . 'display_page_regular_header.php' );
require_once( $functions . 'category-mosaics/display_all.php' );
require_once( $functions . 'category-mosaics/display_items.php' );
