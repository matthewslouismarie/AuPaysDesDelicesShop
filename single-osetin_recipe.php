                ...
                <?php if(osetin_get_field('recipe_serves')){ ?>
                  <div class="ingredient-serves">
                    ...
                    <div class="servings-adjuster-control">
                      ...
                      <input class="ingredient-serves-num" type="text" data-current-serves-num="<?php echo get_field( 'recipe_serves' ); ?>" value="<?php echo get_field( 'recipe_serves' );?>" />
                      ...
                      <?php }else{ ?>
                        ...
                        <td>
                          ...
                          <?php if($searchable_ingredients){ ?>
                            ...
                            $ingredient_link_html = the_sub_field('ingredient_name');
                            if($ingredient_obj){
